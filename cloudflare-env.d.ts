/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 131331847b430a80cf3317758efaeb0b)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	GITHUB_PUBLISH_MODE_STORE: SecretsStoreSecret;
	CONTENT_DEPLOY_HOOK_URL_STORE: SecretsStoreSecret;
	GITHUB_APP_ID_STORE: SecretsStoreSecret;
	GITHUB_APP_INSTALLATION_ID_STORE: SecretsStoreSecret;
	GITHUB_APP_PRIVATE_KEY_STORE: SecretsStoreSecret;
	GITHUB_REPOSITORY_STORE: SecretsStoreSecret;
	GITHUB_BASE_BRANCH_STORE: SecretsStoreSecret;
	ACCESS_TEAM_DOMAIN_STORE: SecretsStoreSecret;
	ACCESS_POLICY_AUD_STORE: SecretsStoreSecret;
	...
	CONTENT_DEPLOY_HOOK_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_REPOSITORY" | "GITHUB_BASE_BRANCH" | "ACCESS_TEAM_DOMAIN" | "ACCESS_POLICY_AUD" | "CONTENT_DEPLOY_HOOK_URL">> {}
}
declare module "*.md" {
	const value: string;
