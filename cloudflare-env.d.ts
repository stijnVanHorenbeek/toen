/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 2d21898c7acaae23d98a938b3d1d7e27)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_REPOSITORY" | "GITHUB_BASE_BRANCH" | "ACCESS_TEAM_DOMAIN" | "ACCESS_POLICY_AUD">> {}
}
declare module "*.md" {
	const value: string;
